...
class VTracerImageVectorizerNode:
    ...
    FUNCTION = "execute"
    OUTPUT_NODE = True
    CATEGORY = "ComfyUI-YarvixPA/Image/Rasterize"
    DESCRIPTION = "Vectorizes an image into SVG or PDF format using VTracer."
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "VTracerImageVectorizerNode": "🚀 VTracer (Image vectorizer)"
}